...
public class Application {
    public static void main(String[] args) {
        /*super 와 super() 에 이해할 수 있다.
        *
        * super : 자식클래스를 이용해서 객체를 생성할 떄 부모의 생성자도
        *           호출하여 부모 클래스의 인스턴스도 같이 생성하게 된다.
        *           이 떄 생성한 부모 클래스의 인스턴스 주소를 보관하는
        *           래퍼런스 변수이다.
        ...
        *  */
        ...
        Product product2 = new Product("S-01234", "삼송", "갠역시폴드6", 234235234, LocalDateTime.now());
        ...
        Computer computer3 = new Computer("S-01234", "삼송", "갠역시폴드6", 234235234, LocalDateTime.now(),
                "인텔", 512, 16, "윈도우");
