...
public class Application1 {
    public static void main(String[] args) {
        ...
        * java 에서 컬렉션 프레임워크는 여러개의 다양한 데이터들을
        ...
        * -크기변경, 요소의 추가, 삭제, 정렬 기능을 미리 메소드로 만들어서
        * -우리에게 제공을 해주고 있다.
        * */
        //어레이리스트 인스턴스를 생성하면 10칸 짜리의 배열을 만들어준다.
        ArrayList alist = new ArrayList();
        //인터페이스는 생성자를 가질 수 없기 떄문에 직접적으로 인스턴스 생성이 불가능하다
        //그러면 어떻게 해야 될까?
        //List 인터페이스를 상속받은 클래스로 인스턴스를 생성하면 된다.
      //  List list new List();
        //List 를 상속받은 ArrayList 클래스를 이용해서 인스턴스 생성
        //이 과정이 다형성이다.
        //다형성을 적용해서 상위 래퍼런스로 ArrayList 객체를 만들 수 있다.
        ...
        for(int i = 0; i < alist.size(); i++) {
            // 인덱스에 해당하는 값을 가져올 떄는 get() 메소드를 사용한다.
        ...
        * 따라서 우리가 <> 내부에 탕비을 지정하면 해당하는 공간을 지정한 타입 외에는 사용할 수 없게 된다.*/
        ...
        * 인스턴스를 생성할 수 있다.
        * 컬렉션에서 값을 일겅오는 방식을 통일된 방식으로 제공하기 위해 사용
        ...
        * next() : 다음 요소 반환*/
        ...
        /*dIter 라는 래퍼런스 변수에 내림차순 한 결과를 담았기 떄문에
        * 다시한번 ArrayList 로 옮길 것이다*/
