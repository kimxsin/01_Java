...
public class UserDTO {
    ...
    * */
    ...
    //동일한 이름을 가진 생성자 혹은 메소드를 한 클래스 안에서 작성하는건 불가능

    /*2. 매개변수가 있는 생성자
    * */
    public UserDTO(String id, String pwd, String name) {
        /*id, pwd, name 초기화를 담당하는 생성자
        * -분명 동일한 이름은 사용했지만, 컴파일 오류가 발생하고 있지 않다.
        ...
        * */
        ...
        this.pwd = pwd;
        this.name = name;
        System.out.println("UserDTO 의 매개변수가 있는 생성자를 호출함...");
    }
        //3. 모든 필드를 초기화하는 생성자.
