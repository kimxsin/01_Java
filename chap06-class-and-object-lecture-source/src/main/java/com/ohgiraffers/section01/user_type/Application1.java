...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.print("hobbise : ");
        for(int i = 0; i < hobbies.length; i++) {
            System.out.print(hobbies[i] + " ");
        }
        System.out.println();
        /*이렇게 각기다른 변수로 데ㅐ이터를 관리하게 되면 여러가지 단점이 있다.
        * 1. 변수명을 다 알아야 한다
        ...
        * heap 메모리 공간에 할당을 해야 한다.  */
        ...
        /*index. 2. 생성된 인스턴스(객체의) 초기값 확인하기
        *  comment.
        * 우리가 Member 클래스에 작성한 전역변수(필드)에 접근하기 위해서는
        * 래퍼런스변수명.변수명 <- 이 방법으로 접근 할 수 있다.
        ...
        * */
        ...
        /*index. 2-3 필드(전역변수에) 접근해서 변수처럼 사용해보기*/
        member.id = "user02";
        member.pwd = "pass02";
        member.name = "조평순";
        member.age = 20;
        ...
        System.out.println("member.age : " + member.age);
        System.out.println("member.gender : " + member.gender);
        System.out.print("member.hobbies : ");
