...
public class Application {
    public static void main(String[] args) {
        ...
        * singleton 패턴이란
        * 어플리케잇현이 시작될 때 어떠한 클래스가 최초 한 번만
        ...
        * - 나지만, 두 번쨰 이용 시에는 인스턴스 생성 시간 없이 사용 가능
        * - 인스턴스가 절대적으로 한 개만 존재한느 것을 보장할 수 있다.
        * 단점
        * - 싱글톤 인스턴스가 너무 많은 일을 하거나 많은 데이터를 공유하면
        * - 결함도가 높아진다. (결함도가 높아지는 것 -> 한 곳 수정 시 다른 곳도 수정 필요)
        * - 동시성 문제를 고려해야 하기 떄문에 난이도가 있다.
        *
        * - 싱글톤 구현 방법
        * 1. 이른 초기화 Eager
        * 2. 게으른 초기화 Lazy
        *
        * 1. 이른 초기화 구현
        *  기본 생성자가 private 이기 때문에 인스턴스 생성 불가
