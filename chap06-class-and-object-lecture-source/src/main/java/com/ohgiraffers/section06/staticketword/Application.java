package com.ohgiraffers.section06.staticketword;

public class Application {
    public static void main(String[] args) {
        /*static 키워드에 대해 이해할 수 있다.
         * static
         * 정적 메모리 영역에 프로그램이 start 될 떄 할당하는 키워드이다.
         ...
         * 하지만 static 필드의 경우 클래스변수 자체가 프로그램을 종료할 떄까지
         ...
         * 인스턴스를 생성하지 않고 호출 할 목적으로 작성을 하기 떄문에
         * 아래처럼 사용하는 것은 권장하지 않는다*/
        /*7. static 메소드 호출*/
        //static 키워드 가 붙은 메소드는 인스턴스를 생성하지 않고 호출할 수 있기 떄문에 클래스명.메소드명() 이렇게 호출한다
      //  StaticFieldTest.staticMethod();
