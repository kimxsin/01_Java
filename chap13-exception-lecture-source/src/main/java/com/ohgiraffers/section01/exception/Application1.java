...
public class Application1 {
    public static void main(String[] args) throws Exception {
        ...
        * 1. throws 위임*/
        ...
        /*상품을 사야하는데 상품 가격은 30000원 이고
        * 내가 가진 돈이 50000원 인 경우,
