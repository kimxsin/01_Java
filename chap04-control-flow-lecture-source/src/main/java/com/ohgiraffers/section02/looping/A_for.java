...
public class A_for {
    public void testSimpleForStatement() {
        ...
        // 1 부터 10 까지 1 씩 증가시키면서 i 값을 출력하는 반복문
        // 초기식 : int i = 1;
        // 조건식 : i <= 10;
        // 증강식 : i++
...
//        /*숫자 두개를 입력받아 작은 수에서 큰 수까지의 합을 구하시오
...
//            System.out.println("sum : " + sum);
    ...
    public void printSimpleGugudan(){
        ...
        * 그렇지 않은 경우 " 반드시 2~ 9 사의 양수를 입력해주세요"
        * 를 출력해보자.
        * */
