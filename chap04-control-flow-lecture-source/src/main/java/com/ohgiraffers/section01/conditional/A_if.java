...
public void testSimpleIfStatement() {
    ...
    int num = sc.nextInt();
    //2. 조건 생각해보기. 짝수-> 어떠한 수를 2로 나누었을떄 나머지가 0이면 짝수다
    if(num % 2 == 0) {
    ...
    /*3. 문제
    * 점수 한 개를 입력 받아 그 수가 양수인 경우에만 짝수인지를 확인하여
    * 짝수이면 "압력하신 숫자는 양수이면서 짝수입니다" 를 출력하고,
    * 둘 중 하나라도 해당하지 않으면 아무 내용도 출력하지 않는 구문을 작성해보자.
    * 단 조건과 상관 없이 프로그램이 종료될 떄, "프로그램을 종료합니다" 라고
    * 출력되도록 해보자
    * */
        Scanner sc = new Scanner(System.in);
