...
public class C_ifElseIf {
    ...
    //if, if-else, if-else-if 문 단독 사용에 대한 흐름 이해하고 적용할 수 있다.

    /*[if-else-if 문 표현식]
    * if(조건식 ) {
    * 조건식 1이 true 일 때 실행할 구문;
    * } else if(조건식 2) {
    * 조건식 1이 false 이고 조건식 2가 true 일 때 실핼할 구문;
    * } else {
    ...
    * */
    ...
    public void testIfElseIfStatement () {
        ...
        if(answer == 1) {
            ...
            System.out.println("산싱령 : 오호 아주 정직한 아이로구나!! 여기 있는 도끼를 너에게 다 주겠노라");
        } else {
            System.out.println("산싱령 : 뭐라는거냐?");
        }
    ...
    public void testNestedIfElseIfstatement(){
        ...
        System.out.println("학생의 점수는 " + point + " 이고, 등급은 " + grade + " 입니다.");
        }
