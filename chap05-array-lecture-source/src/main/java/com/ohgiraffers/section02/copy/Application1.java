...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 가르키고 있기 때문에 변경 된 값이 반영되어 있다.
         * */

        //얕은 복사 확인을 위한 원본 배열 만들기
        int[] originArr = {1, 2, 3, 4, 5};  // = int o = new int[5]; o[0] = 1; o[1] = 2;
        //새로운 배열 만들어서 주소 복사하기
        int[] copyArr = originArr;

        //hashcode() 를 이용해 진짜로 같은지 비교
        System.out.println("원본배열의 주소값 : " + originArr.hashCode());
        System.out.println("복제배열의 주소값 : " + copyArr.hashCode());

        //원본 배열과 복제 배열의 값을 반복문을 통해 출력
        ...
        //복제한 배열의 값을 수정하고 , 원본도 반영 되었는 지 확인
