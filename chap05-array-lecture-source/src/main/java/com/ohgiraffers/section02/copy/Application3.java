...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        //4. Arrays 의 copyOf() 메소드를 이용한 복사
        //1. 복사하고싶은 배열(originArr)
        //2. 만들고싶은 배열의 길이
